...
public class WebDriverUtils {
	 ...
	 * @param waitSecond
	 */
	public void waitForAllElementsToLoad(WebDriver driver, int waitSecond) {
	 ...
	 * @param waitSecond
	 */
	public void waitUntilElementGetsVisible(WebDriver driver, WebElement element, int waitSecond) {
	 ...
	 * @param waitSecond
	 * 
	 * @return boolean true if url matches and false if url doesnt matches
	 */
	public boolean urlVerification (WebDriver driver, String fractionURL, int waitSecond) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(waitSecond));
		wait.until(ExpectedConditions.urlContains(fractionURL));
		String actualUrl = driver.getCurrentUrl();
		if (actualUrl.contains(fractionURL)) {
			return true;
		} else {
			return false;
		}
	 ...
	 */
	public void verifyTitle (WebDriver driver, int waitSecond, String expectedPageTitle) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(waitSecond));
	 ...
	 * @param waitSecond
	 */
	public void waitUntilElementGetsClickable(WebDriver driver, WebElement element, int waitSecond) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(waitSecond));
	 ...
	 * @param waitTime
	 */
	public void acceptAlert(WebDriver driver, int waitTime) {
	 ...
	 */
	public String getAlertMessage(WebDriver driver, int waitTime) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(waitTime));
	 ...
	 * @param waitTime
	 */
	public void abortAlert(WebDriver driver, int waitTime) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(waitTime));
	 ...
	 * @param waitTime
	 */
	public void printAlertMessageAndAcceptAlert(WebDriver driver, int waitTime) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(waitTime));
	 ...
	 */
	public void acceptAlertWithAssert(WebDriver driver, int waitSecond, String expectedAlertMessage) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(waitSecond));
