...
public class DatabaseUtils {
	...
	/**
	 * This method is used to Register the Driver and Establish the connection with
	 * Database
	 * 
	 * @throws SQLException
	 */
	...
	/**
	 * This method is used to execute the select query and to retrieve the data from
	 * the database
	 * 
	 * @param columnData
	 * @param expectedData
	...
	public String executeAndGetData(String columnData, String expectedData, String query) throws SQLException {
		...
		if (flag) {
			System.err.println("PASS : Data is verified.");
			return expectedData;
		} else {
