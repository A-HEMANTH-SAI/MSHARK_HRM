...
public class JavaUtils {
	 ...
	 */
	public static void simulateRobotKeyPress(int keyCode, int delayMicroSecond) {
		try {
			Robot robot = new Robot();
			// Simulate key press
			robot.keyPress(keyCode);
			robot.delay(delayMicroSecond);
	 ...
	 */
	public static void simulateRobotKeyRelease(int keyCode, int delayMicroSecond) {
		try {
			Robot robot = new Robot();
	 ...
	 * @throws AWTException
	 */
	public void simulateRobotkeyEnterKeyPress(int delayMicroSecond) throws AWTException {
		try {
			Robot robot = new Robot();
	 ...
	 * @throws AWTException
	 */
	public void simulateRobotkeyEnterKeyRelease(int delayMicroSecond) throws AWTException {
		try {
			Robot robot = new Robot();
